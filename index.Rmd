...
clinic_vs_med |>
  ggplot(mapping = aes(x = is_health_clinic, y = mean_no_med)) + geom_col(binwidth = 1) + labs(x = "Is there a Health Clinic?", y = "Average Tendency of Going Without Medical Treatment")
```
